...
let all =
  ...
  ; Event.create
      ...
      ~outcome:
        (Yes
           (Explanation.create
              ~link:"https://www.link.that/proves/event/2"
              ~date:(Date.of_string "2025-01-01")
              ~description:"Description proving event 2"
              ()))
  ; Event.create
      ...
      ~outcome:
        (No
           (Explanation.create
              ~date:(Date.of_string "2025-12-31")
              ~description:"Description that describes why event 3 didnt happen"
              ()))
  ]
;;
