...
let all =
  List.mapi
    ...
    ; Event.create
        ...
        ~precise:
          "The top grossing domestic film of Q4 2025 (October through December), \
           ...
           Sciences)."
        ~label:"box office"
        ~outcome:(Some (Outcome.create No (Date.of_string "2025-12-31") "The top grossing film was Wicked: For Good."))
    ; Event.create
    ...
    ; Event.create
        ...
        ~label:"christmas"
        ~outcome:
          (Some (Outcome.create No (Date.of_string "2025-12-25") "It did not snow."))
    ]
;;
