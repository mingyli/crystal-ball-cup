...
let all =
  List.mapi
    ...
    ; Event.create
        ...
        ~outcome:(Yes (Explanation.create ~link:"https://www.instagram.com/p/DOUPJaRiXFD/" ~date:(Date.of_string "2025-09-07") ~description:"Carlos Alcaraz (Born May 5, 2003, Age 22) defeated Jannik Sinner 6-2 3-6 6-1 6-4 to win the 2025 US Open Men's Singles tournament" ()))
    ; Event.create
    ...
    ; Event.create
        ...
        ~outcome:(Yes (Explanation.create ~link:"https://www.instagram.com/p/DN02niAXMM-/" ~date:(Date.of_string "2025-08-26") ~description:"Travis Kelce and Taylor Swift were engaged on August 26th, 2025 as confirmed on instgram." ()))
    ; Event.create
    ...
    ; Event.create
        ...
        ~outcome:(Yes (Explanation.create ~link:"https://www.espn.com/olympics/trackandfield/story/_/id/46269417/armand-duplantis-breaks-pole-vault-world-record-14th" ~date:(Date.of_string "2025-09-15") ~description:"Armand \"Mondo\" Duplantis broke the men's pole vault record by clearing a height of 20 ft, 8 inches" ()))
    ; Event.create
